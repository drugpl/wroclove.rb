...
def speakers
  ...
  [
    ...
    speaker.new(
      ...
      photo: "speakers/reszke-korsan.webp"
    )
  ]
end
  ...
  [
    {
      ...
      slots: [
        ...
        slot.new(
          ...
          description: "Modern web applications demand interactivity, but does that mean "\
                       "you need to reach for a heavy JavaScript framework? Not anymore! "\
                       "Hotwire offers a seamless way to build reactive, dynamic interfaces "\
                       "while keeping the simplicity of server-side rendering in Rails. "\
                       "In this hands-on workshop, you'll learn how to transform a traditional "\
                       "Rails application from static pages to a fully interactive experience "\
                       "using Hotwire - a combination of Turbo (Turbo Frames & Turbo Streams) "\
                       "and Stimulus. We'll take a common feature that would typically be built "\
                       "with React and implement it using Hotwire instead, demonstrating "\
                       "how you can achieve the same level of interactivity with far less complexity. "\
                       "Along the way, we'll dive into typical challenges developers face "\
                       "when adopting Hotwire, such as handling dynamic content updates, "\
                       "managing state, and optimizing performance. You'll see practical solutions "\
                       "that will help you confidently integrate Hotwire into your Rails applications. "\
        ...
        slot.new(
          ...
          description: "Build an AI-powered custom image search engine. "\
                      "Workshop is included in the conference ticket and is limited to 15 participants.",
          tags: ["workshop"]
        ),
        slot.new(
          time: "17:00",
      ...
      slots: [
        ...
        slot.new(
          ...
          description: "Stephen is a software engineer from the US who loves to code and "\
                       ...
                       "tasteful journey to Yippee'. In his talk, Stephen will cover "\
                       "the core philosophy of Yippee, a radically new web framework, "\
                       "and how the Yippee team is building a new set of tools for Ruby "\
                       "from the ground up. While all those tools may seem disparate, "\
                       "when they come together into one vision, they compose an incredibly "\
                       "powerful and unquely magical developer experience.",
          tags: ["talk", "ruby"]
        ),
        slot.new(
          time: "12:00",
